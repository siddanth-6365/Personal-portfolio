      ...
      {/* <section className="">
        ...
        <div class="skills-divlist flex flex-wrap justify-center space-x-4   mt-3 mb-6 items-center gap-4">
          ...
          <li>
            ...
            <p className="text-gray-500" >JavaScript & Typescript</p>

          </li>

          <li>
            <i class="fab fa-c "  ></i>
            <p className="text-gray-500" >C++ (DSA & Oops)</p>
          </li>
          <li>
