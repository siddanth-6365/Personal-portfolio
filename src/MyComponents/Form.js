...
const Form = (props) => {
  ...
  return (
    <>
      ...
      >
        <motion.div
          class="w-full mt-4 md:w-1/2 h-1/2"
          ref={ref}
          animate={controls}
          initial="hidden"
          variants={svgVariant}
        >
          ...
          >
            ...
            <clipPath id="olaolu-work-illo_svg__b">
              <use src="#olaolu-work-illo_svg__a" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__d">
              <use src="#olaolu-work-illo_svg__c" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__f">
              <use src="#olaolu-work-illo_svg__e" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__h">
              <use src="#olaolu-work-illo_svg__g" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__j">
              <use src="#olaolu-work-illo_svg__i" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__l">
              <use src="#olaolu-work-illo_svg__k" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__n">
              <use src="#olaolu-work-illo_svg__m" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__p">
              <use src="#olaolu-work-illo_svg__o" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__r">
              <use src="#olaolu-work-illo_svg__q" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__t">
              <use src="#olaolu-work-illo_svg__s" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__v">
              <use src="#olaolu-work-illo_svg__u" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__x">
              <use src="#olaolu-work-illo_svg__w" overflow="visible"></use>
            </clipPath>
            ...
            <clipPath id="olaolu-work-illo_svg__z">
              <use src="#olaolu-work-illo_svg__y" overflow="visible"></use>
            </clipPath>
